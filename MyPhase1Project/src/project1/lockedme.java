...
public class lockedme {
	...
	public static void main(String[] args) {
		...
		try (// Take user Option from the below mentioned Menu
		Scanner input = new Scanner(System.in)) {
			System.out.println("*****************************************");
			System.out.println("******* Simplilearn Assignment 1 ********");
			System.out.println("*****************************************");
			System.out.println("******* NAYAN SAHARE() *********************");
			...
			do {
				...
				case 1:
					...
					try {
						File file = new File("C:\\Users\\LENOVO\\Desktop\\sample1\\" + filename + ".txt");
				...
				case 3:
					System.out.println("Enter the file name to delete file");
					filename = input.next();
					
				    try{         
					File f= new File("C:\\Users\\LENOVO\\Desktop\\sample1\\" + filename + ".txt");           //file to be delete  
				...
				case 4:  
					...
					File("C:\\Users\\LENOVO\\Desktop\\sample1\\");
	...
	private static void listOfFiles() {
		...
		File folder = new File("C:\\Users\\LENOVO\\Desktop\\sample1\\");
